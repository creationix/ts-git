...
function create(sync: boolean) {
  ...
  function update(chunk: any) {
    if (typeof chunk === "string") return updateString(chunk);
    return updateBuffer(chunk);
  }

  function updateBuffer(buffer: ByteArray) {
